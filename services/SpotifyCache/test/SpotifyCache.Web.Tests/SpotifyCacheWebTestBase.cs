...
{
    public abstract class SpotifyCacheWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SpotifyCacheWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SpotifyCacheWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SpotifyCacheDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SpotifyCacheDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SpotifyCacheDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SpotifyCacheDbContext, Task<T>> func)
        {
            T result;
